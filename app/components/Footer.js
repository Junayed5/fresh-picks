...
export default function Footer() {
  return (
    <div>
      <footer className="max-w-7xl mx-auto bg-white py-32">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div>
            <h3 className="font-semibold text-lg pb-10">
      ...
      <div className="h-20 bg-[#f8f8f8] flex justify-center items-center">
        <p>All Rights Reserved &copy;Copyright 2024 by Junayed.</p>
      </div>
