  ...
  return (
    <div className="bg-[url('https://demo.xpeedstudio.com/marketov2/grocery/wp-content/uploads/sites/12/revslider/grocery/banner3_img-min-1.jpg')] bg-no-repeat bg-center bg-cover h-screen">
      <div className="max-w-7xl mx-auto pt-48">
        <form
          className="bg-white h-96 w-3/5 mx-auto rounded-lg grid grid-cols-2   px-10 py-14"
          action=""
        >
          ...
          <div className="flex justify-center items-center">
            <div>
              <div>
                <p className="text-center text-sm font-serif">Or <br /> Login with</p>
              </div>
              <div className="">
              ...
              <div>
                <p className="text-sm text-center">
                  Not have any account? <Link className="text-primary" href={'/signUp'}>SignUp</Link> here
                </p>
              </div>
            </div>
          </div>
